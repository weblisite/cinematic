              ...
              <div>
                ...
                >
                  <option value="">Select a service</option>
                                  <option value="sponsored-content">Sponsored Content Integration (KSh 150K per episode)</option>
                <option value="cinematic-ads">Cinematic Video Ads (KSh 300K+)</option>
                <option value="day-in-life">Day in the Life Videos (KSh 450K+)</option>
                <option value="mini-movies">Business Mini-Movies (KSh 600K+)</option>
                <option value="branded-reality">Branded Reality Shows (KSh 900K+)</option>
                <option value="branded-competitions">Branded Competitions (KSh 1.2M+)</option>
