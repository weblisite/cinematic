          ...
          <article className="prose prose-lg max-w-none">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="bg-cinematic-gray p-6 rounded-lg">
                ...
                <div className="text-2xl font-bold text-cinematic-gold mb-2">KSh 900,000+</div>
              ...
              <div className="bg-cinematic-gray p-6 rounded-lg border-2 border-cinematic-gold">
                ...
                <div className="text-2xl font-bold text-cinematic-gold mb-2">KSh 2,400,000+</div>
              ...
              <div className="bg-cinematic-gray p-6 rounded-lg">
                ...
                <div className="text-2xl font-bold text-cinematic-gold mb-2">KSh 4,500,000+</div>
