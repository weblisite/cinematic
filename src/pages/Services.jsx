      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          <div className="bg-cinematic-gray p-8 rounded-lg glow-gold">
            ...
            <p className="text-cinematic-gold font-bold text-lg mb-4">Starting at KSh 100,000</p>
            <Link 
          ...
          <div className="bg-cinematic-gray p-8 rounded-lg glow-gold">
            ...
            <p className="text-cinematic-gold font-bold text-lg mb-4">Starting at KSh 150,000</p>
            <Link 
          ...
          <div className="bg-cinematic-gray p-8 rounded-lg glow-gold">
            ...
            <p className="text-cinematic-gold font-bold text-lg mb-4">Starting at KSh 200,000</p>
            <Link 
          ...
          <div className="bg-cinematic-gray p-8 rounded-lg glow-gold">
            ...
            <p className="text-cinematic-gold font-bold text-lg mb-4">Starting at KSh 400,000</p>
            <Link 
        ...
        <div className="bg-gradient-to-r from-cinematic-gold/20 to-cinematic-black p-8 rounded-lg glow-gold mb-12">
          ...
          <div className="text-center">
            ...
            <p className="text-cinematic-gold font-bold text-2xl mb-6">KSh 50,000 per episode</p>
            <Link 
